...
public class ImageLoader {
    ...
    public static void loadImgNoCrop(Context context, ImageView imageView, String photoFilePath) {
        loadImgNoCrop(context, imageView, photoFilePath, R.drawable.load_error);
    }

    public static void loadImgNoCrop(Context context, ImageView imageView, String photoFilePath, int resId) {
        if (TextUtils.isEmpty(photoFilePath)) {
            imageView.setImageResource(R.drawable.load_error);
            return;
        }
