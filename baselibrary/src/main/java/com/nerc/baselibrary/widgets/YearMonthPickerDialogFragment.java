...
import com.nerc.baselibrary.utils.ScreenUtils;
...
public class YearMonthPickerDialogFragment extends android.support.v4.app.DialogFragment {

    protected List<String> mYears = new ArrayList<>();
    private RecyclerView mRv;

    public static YearMonthPickerDialogFragment newInstance() {

        Bundle args = new Bundle();

        YearMonthPickerDialogFragment fragment = new YearMonthPickerDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.year_month_dialog, null);
    ...
    private void initData() {
        ...
        for (int i = 0; i > -3; i--) {
            for (int j = 12; j > 0; j--) {
                mYears.add(String.valueOf(year + i) + "-" + String.valueOf(j));
            }
        }
    }
