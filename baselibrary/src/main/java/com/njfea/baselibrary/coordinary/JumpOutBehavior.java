package com.njfea.baselibrary.coordinary;
...
public class JumpOutBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public JumpOutBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
